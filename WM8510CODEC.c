...
void WM8510Init()
{
	...
	// Halt when the processor is idle.
	DCICON1bits.DCISIDL = 1;
	// No digital loop back.
	DCICON1bits.DLOOP = 0;
	//Sample Clock Direction Control bit
	DCICON1bits.CSCKD = 1;
	//Sample Clock Direction Control bit
	DCICON1bits.CSCKE = 1;
	// Frame Synchronization Direction Control bit
	DCICON1bits.COFSD = 1;
	// Underflow Mode bit
	DCICON1bits.UNFM = 0;
	// Serial Data Output Mode bit
	DCICON1bits.CSDOM = 0;
	// DCI Data Justification Control bit
	DCICON1bits.DJST = 0;
	// Frame Sync Mode bits
	DCICON1bits.COFSM = 0b00;
